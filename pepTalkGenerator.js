...
function createTextOutput() {
  textDiv = createDiv('');
  textDiv.id('textOutput'); // Set an ID for styling
  textDiv.style('width', '90%'); // Optional, for consistency
  textDiv.style('max-width', '700px'); // Limit max width for larger screens
  ...
  textDiv.style('background-color', 'rgba(255, 255, 255, 0.8)');
}
